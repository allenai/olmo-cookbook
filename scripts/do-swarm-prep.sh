...
for i in $(seq -f "%04g" 0 47); do
    ...
    python -m cookbook.remote \
        s3://ai2-llm/checkpoints/ai2-tylerm/olmo2-pdfs-datadelve-5xC-30m-augusta-2048-$group_id-$i/step22200/ \
        weka://oe-data-default/ai2-llm/checkpoints/ai2-tylerm/5xC-30m-$group_id-$i/step22200 \
        --workspace ai2/dolma2
done

# for i in $(seq -f "%04g" 2 47); do
#   echo "Converting checkpoint $i..."
#   olmo-cookbook-eval convert "/oe-training-default/ai2-llm/checkpoints/mayeec/olmo2-5xC-30m-dense-${group_id}-${i}/step22200" \
#     -t olmo-core-v2 \
#     --use-beaker \
...
#     CHECKPOINT="/oe-data-default/ai2-llm/checkpoints/ai2-tylerm/olmo2-pdfs-datadelve-5xC-30m-augusta-2048-${group_id}-${i}/step22200-hf"
