...
class WrappedTransformerConfig:
    ...
    @classmethod
    def qwen3_layerwise_8B(cls, tokenizer: TokenizerConfig, **kwargs) -> TransformerConfig:
        """
        An 8B Llama3-like model config.
        """
        config = getattr(TransformerConfig, "llama_like")(
    ...
    @classmethod
    def llama3_8B_swa(cls, tokenizer: TokenizerConfig, **kwargs) -> TransformerConfig:
        """
        An 8B Llama3-like model config.
        """
        config = getattr(TransformerConfig, "llama_like")(
    ...
    @classmethod
    def llama3_8B_plus_qk_reorder_norm(cls, tokenizer: TokenizerConfig, **kwargs) -> TransformerConfig:
        """
        An 8B Llama3-like model config.
        """
        config = getattr(TransformerConfig, "llama_like")(
    ...
    @classmethod
    def llama3_8B_plus_qk(cls, tokenizer: TokenizerConfig, **kwargs) -> TransformerConfig:
        """
        An 8B Llama3-like model config.
        """
        config = getattr(TransformerConfig, "llama_like")(
    ...
    @classmethod
    def olmo25_7b_gqa_swa(cls, tokenizer: TokenizerConfig) -> TransformerConfig:
        """
        OLMo2.5 retrofit
        """
