...
class DownstreamEvaluator(Enum):
    ...
    MMLU_STEM_RC_5SHOT = "mmlu_stem_rc_5shot"
    MMLU_HUMANITIES_RC_5SHOT = "mmlu_humanities_rc_5shot"
    MMLU_SOCIAL_SCIENCES_RC_5SHOT = "mmlu_social_sciences_rc_5shot"
    MMLU_OTHER_RC_5SHOT = "mmlu_other_rc_5shot"
    MMLU_STEM_RC_5SHOT_TEST = "mmlu_stem_rc_5shot_test"
    MMLU_HUMANITIES_RC_5SHOT_TEST = "mmlu_humanities_rc_5shot_test"
    MMLU_SOCIAL_SCIENCES_RC_5SHOT_TEST = "mmlu_social_sciences_rc_5shot_test"
    MMLU_OTHER_RC_5SHOT_TEST = "mmlu_other_rc_5shot_test"
