...
objects = s3fs.S3FileSystem().ls(
    "ai2-llm/pretraining-data/sources/cc_all_dressed/cc_news/sa_minlen500/filtered/annotated/"
)
print(len(objects))
...
SRC_S3_PREFIX="s3://ai2-llm/pretraining-data/sources/cc_all_dressed/cc_news/sa_minlen500/filtered/annotated"
DST_S3_PREFIX="s3://ai2-llm/pretraining-data/sources/cc_all_dressed/cc_news/sa_minlen500/filtered/annotated_may31_lr05_ng3_n3M6_ova_combined-v3-partitioned"
