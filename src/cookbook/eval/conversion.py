...
def convert_olmo_core_v2(
    ...
    transformers_commit_branch: Optional[str] = None,
    ...
    try:
        ...
        huggingface_code_dir = install_transformers(transformers_commit_hash, transformers_commit_branch, env, git_url=transformers_git_url)
...
def run_checkpoint_conversion(
    ...
    if use_beaker:
        ...
        remote_command = [
            ...
            f"--huggingface-transformers-commit-branch {huggingface_transformers_commit_branch}",
    ...
    if olmo_type == "olmoe":
        return convert_olmoe(
            ...
            transformers_commit_branch=huggingface_transformers_commit_branch,
            env=env,
        )
